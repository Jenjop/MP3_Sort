...
def fileNameTest(filename):
    return ('mp3_sort' not in filename) and ('ini' not in filename) and ('py' not in filename) and (os.path.isfile(filename) and ('.m3u' not in filename) and ('.project' not in filename) and ('.pydevproject' not in filename) and ('.txt' not in filename) and ('.html' not in filename))
